...
Version `0.4.0` is acceptable when the Python, Docker, web and browser quality gates pass; the OpenAPI contract is current; production builds succeed; and the complete user journeys work on Chromium, WebKit and their mobile projects.
